...
export {
    ...
    EMAIL_REQUEST, EMAIL_RESPONSE, THRESHOLD_VIOLATION, URL, MQTT_PORT, TOPICS, MOISTURE, TEMP, HUMIDITY,
    MOISTURE_SENSOR_1, SECONDS_TO_MILLI, POLL_INTERVAL, TEMP_SENSOR_SERVICE, MOISTURE_SENSOR_SERVICE, 
    ONLINE, MESSAGE, MOISTURE_SENSOR_2, TEMP_HUMIDITY_SENSOR, MOISTURE_LOW,TEMP_LOW, TEMP_HIGH, 
    HUMID_LOW, HUMID_HIGH, THRESHOLD_SERVICE, ALL, SENSOR1_I2C_ADDRESS, SENSOR1_I2C_BUS_NUMBER, SENSOR2_I2C_ADDRESS,
    SENSOR2_I2C_BUS_NUMBER, AVERAGE, DEFAULT_GLOBAL_TIMEOUT_MS, resolveCacheMap, MIN_MAX, URN, GATEWAY_API_PORT,
    TOUCH_BASE, TOUCH_CHANNEL_OFFSET, SSE_PORT, DHT_SENSOR_VERSION, DATA_OUT_PIN
}
